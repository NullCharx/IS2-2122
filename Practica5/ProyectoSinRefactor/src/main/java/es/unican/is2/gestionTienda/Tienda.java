...
public class Tienda {
	 ...
	 */
	//Complejidad ciclomatica: 2 + 2 + 1 + 1 + 1 + 1 +1 = 9
	//Complejidad cognitiva: 2+1+1+1+1+1+1 = 8
	public Vendedor buscaVendedor(String id) {
		...
		try {//CCog 1 (catch) + 1 (finally)
			...
			while (in.hasNext() && !in.next().equals("Junior")) { //CC 2, CCog 1 (While) 
			...
			while (in.hasNext() && !in.next().equals("Prácticas")) { //CC 2, CCcog 1
				String nombre = in.next();
				in.next();
				String idIn = in.next();
				in.next();
	 ...
	 */
	//Complejidad ciclomatica: 2 + 2 + 1 + 1 +1 = 7
	//Complejidad cognitiva: 2+1+1+1+1=6 
	 ...
	 */
	//Complejidad ciclomatica: 1+1+1+1+1+1+1+1+1=9
